...
в [основную тему Consta](##LIBS.STAND/stand:uikit-components-theme-stable, вы можете перечислить переменные,
...
Пересчет переменных зависит от [модификаторов темы](##LIBS.STAND.TAB/tab:dev/stand:uikit-components-theme-stable/hash:модификаторы) (цвета, размеры элементов, шрифты, отступы и так далее). Если эти модификаторы не меняются, пересчёт не происходит.
