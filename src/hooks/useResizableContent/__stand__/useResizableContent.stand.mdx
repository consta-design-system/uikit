...
Хук `useResizableContent` позволяет сделать блоки в контейнере с изменяемыми размерами.
...
| ------------ | -------------------------------------------------------------------------------- | -------------- | --------------------------------------------- |
| `refs`       | `Array<UseResizableContentRef`<code>&#124;</code>`React.RefObject<HTMLElement>>` | -              | Ссылки на изменяемые элементы                 |
