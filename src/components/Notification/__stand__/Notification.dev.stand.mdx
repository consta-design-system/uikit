...
- [Свойства компонента Notification](#свойства-компонента-notification)
- [Содержимое элементов](#содержимое-элементов)
  - [Пример](#пример)
- [Группировка](#группировка)
  - [Группировка по признаку в элементе](#группировка-по-признаку-в-элементе)
  - [Группировка по массиву групп](#группировка-по-массиву-групп)
- [Кастомизация](#кастомизация)
  - [Использование с всплывающие окнами](#использование-с-всплывающие-окнами)
  - [Кастомный рендеринг](#кастомный-рендеринг)
