...
и относительного: `'1-of-4' | '1-of-3' | '1-of-2' | '2-of-3' | '3-of-4' | 'full'`.

```tsx
<Sidebar {...props} size="2-of-3">
  ...
</Sidebar>
```
...
| [`size?`](#размер)           | `'1-of-4', '1-of-3', 's', '1-of-2', '2-of-3', 'l', 'm', '3-of-4', 'full'` | `m`                    | Размер сайдбара                                              |
