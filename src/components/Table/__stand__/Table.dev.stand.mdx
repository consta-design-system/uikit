...
Чтобы объядинить ячейки по горизонатали не обходимо задать число колонок или функцию оопределения размера в описании колонки `сolSpan: 2`.
Соседние ячейки слева направо будут объединятся.
