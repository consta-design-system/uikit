...
[Посмотреть пример](##LIBS.LIB.STAND/lib:uikit/stand:components-table-stable) (см. Пример таблицы с зафиксированным заголовком)
...
[Посмотреть пример](##LIBS.LIB.STAND/lib:uikit/stand:components-table-stable) (см. Пример таблицы с зафиксированной колонкой)
...
[Посмотреть пример](##LIBS.LIB.STAND/lib:uikit/stand:components-table-stable) (см. Пример таблицы со скрытыми колонками)
...
[Посмотреть пример](##LIBS.LIB.STAND/lib:uikit/stand:components-table-stable) (см. Пример таблицы с ячейками, объединёнными кастомной функцией)
...
- `truncate` — текст обрезается, в конце появляется троеточие,
...
Для того чтобы данная функция работала необходимо ограничение контента по ширине, для этого необходимо в параметрах `columns` указать ее ширину (по умолчанию ширина не ограничена и контент не обрезается, а рендерится целиком).
...
[Посмотреть пример](##LIBS.LIB.STAND/lib:uikit/stand:components-table-stable) (см. Пример таблицы с дополнительным элементом в заголовке)
...
[Пример в работе](##LIBS.LIB.STAND/lib:uikit/stand:components-table-stable) (см. Пример таблицы с добавлением/удалением строк)
...
[Посмотреть пример](##LIBS.LIB.STAND/lib:uikit/stand:components-table-stable) (см. Пример таблицы со своим текстом, если нет данных)
...
[Посмотреть пример](##LIBS.LIB.STAND/lib:uikit/stand:components-table-stable) (см. Пример таблицы с большим количеством строк)
...
[Посмотреть пример](##LIBS.LIB.STAND/lib:uikit/stand:components-table-stable) (см. Пример таблицы с обработкой клика по ячейке)
...
[Посмотреть пример](##LIBS.LIB.STAND/lib:uikit/stand:components-table-stable) (см. Пример таблицы с кастомными фильтрами)
...
[Посмотреть пример](##LIBS.LIB.STAND/lib:uikit/stand:components-table-stable) (см. Пример таблицы со своей функцией переименования тега в фильтре)
...
[Посмотреть пример](##LIBS.LIB.STAND/lib:uikit/stand:components-table-stable) (см. Пример таблицы с дополнительным классом)
