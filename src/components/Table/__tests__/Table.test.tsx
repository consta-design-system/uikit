    ...
    describe('Проверка кастомных фильтров', () => {
      ...
      describe('Проверка TableTextFilter', () => {
        ...
        it('Кнопка "Выбрать все" доступна, если есть хотя бы 1 невыделенный отфильтрованный вариант', () => {
          // Тест ловит случай, когда количество активных элементов равно количеству отфильтрованных
          // (они не обязательно совпадают): здесь активен Peter, а отфильтрован Alex
        ...
        it('Кнопка "Выбрать все" недоступна, если выбраны все отфильтрованные варианты', () => {
          // Тест ловит случай, когда количество активных элементов превышает количество отфильтрованных
          // (они не обязательно совпадают): здесь активен Peter и Alex, а отфильтрован Alex
