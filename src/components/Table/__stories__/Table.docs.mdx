...
// import {
//   TableExampleNoSortable,
//   TableExampleSort,
// } from './examples/TableExampleSort/TableExampleSort';
...
- [Внешний вид](#внешний-вид)
  ...
  - [Дополнителный CSS-класс по условию](#дополнительный-css-класс-по-условию)
...
При вертикальной прокрутке строги будут двигаться, а заголовок остается на месте —
...
export function TableExampleMerge() {
  return <Table columns={columns} rows={rows} borderBetweenRows borderBetweenColumns />;
}
```
