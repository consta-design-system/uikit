...
| --------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------ | --------------------------------------------------- |
| columns               | `{ title: React.ReactNode; accessor: string; align?: 'left', 'center', 'right'; withoutPadding?: boolean; width?: number; sortable?: boolean; sortByField?: string }[]` | -            | Колонки таблицы                                     |
| rows                  | `{ [key: string]: React.ReactNode; id: string }[]`                                                                                                                      | -            | Строки таблицы                                      |
| filters?              | `{ id: string; name: string; field: string; filterer: (value: FieldValue) => boolean; }[]`                                                                              | -            | Список фильтров                                     |
...
| emptyRowsPlaceholder? | `React.ReactNode`                                                                                                                                                       | -            | Компонент заглушка для отображения когда нет данных |
...
import { Table } from '@gpn-design/uikit/Table';
