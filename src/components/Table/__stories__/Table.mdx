...
`expander` — указывает что данная колонка используется для разворачивания вложенных строк.
...
Строки могут быть разворачиваемыми, за вложенные строки отвечает свойство `children`

Это используется для вывода иерархических данных в таблице:
