...
| [`dropdownOpen?` ](#управление-состоянием-выподающего-списка)                              | `boolean`                                                                                                                                                                                                                                                   | -                                                   | Состояние открыт/закрыт выпадающего списка                                                                                            |
| [`ignoreOutsideClicksRefs?`](#управление-состоянием-выподающего-списка)                    | `ReadonlyArray<React.RefObject<HTMLElement>>`                                                                                                                                                                                                               | -                                                   | Ссылки на элементы, которые нужно игнорировать при кликах вне компонента                                                              |
