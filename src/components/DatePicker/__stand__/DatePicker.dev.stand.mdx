...
import { DatePickerExampleOnError } from '../__stories__/examples/DatePickerExampleOnError/DatePickerExampleOnError';
import { DatePickerExampleFormat } from '../__stories__/examples/DatePickerExampleFormat/DatePickerExampleFormat';
import { DatePickerExampleAdditionalControls } from '../__stories__/examples/DatePickerExampleAdditionalControls/DatePickerExampleAdditionalControls';
import { DatePickerExampleStatus } from '../__stories__/examples/DatePickerExampleStatus/DatePickerExampleStatus';
import { DatePickerExampleLabel } from '../__stories__/examples/DatePickerExampleLabel/DatePickerExampleLabel';
import { DatePickerExampleRequired } from '../__stories__/examples/DatePickerExampleRequired/DatePickerExampleRequired';
import { DatePickerExampleCaption } from '../__stories__/examples/DatePickerExampleCaption/DatePickerExampleCaption';
import {
...
} from '../__stories__/examples/DatePickerExampleType/DatePickerExampleType';
import { DatePickerExampleMulti } from '../__stories__/examples/DatePickerExampleMulti/DatePickerExampleMulti';
import { DatePickerExampleTwoIcons } from '../__stories__/examples/DatePickerExampleTwoFields/DatePickerExampleTwoFields';
import { DatePickerExampleWithClearButton } from '../__stories__/examples/DatePickerExampleWithClearButton/DatePickerExampleWithClearButton';
...
export const DatePickerExampleWithClearButton = () => {
  ...
  return <DatePicker value={value} onChange={({ value }) => setValue(value)} withClearButton />;
};
```
...
| `minDate?`                                                                 | `Date`                                                                                                                                                                                                                                                      | `01.01.0001 00:00:00` | Ограничение выбора по меньшей дате, см. [DateTime](##LIBS.STAND\|stand:uikit-components-datetime-stable)                       |
| `maxDate?`                                                                 | `Date`                                                                                                                                                                                                                                                      | `31.12.9999 23:59:59` | Ограничение выбора по большей дате, см. [DateTime](##LIBS.STAND\|stand:uikit-components-datetime-stable)                       |
| `events?`                                                                  | `Date[]`                                                                                                                                                                                                                                                    | -                     | События на календаре, см. [DateTime](##LIBS.STAND\|stand:uikit-components-datetime-stable)                                     |
| `dateTimeView?`                                                            | `'classic'` &#124; `'book'` &#124; `'slider'`                                                                                                                                                                                                               | `'classic'`           | Вид календаря: одна страничка, две странички или слайдер, см. [DateTime](##LIBS.STAND\|stand:uikit-components-datetime-stable) |
| `locale?`                                                                  | `Locale`                                                                                                                                                                                                                                                    | `ruLocale`            | Локализация, см. [DateTime](##LIBS.STAND\|stand:uikit-components-datetime-stable)                                              |
...
| `disabled?`                                                                | `boolean`                                                                                                                                                                                                                                                   | -                     | Отключает возможность ввода, см. [TextField](##LIBS.STAND\|stand:uikit-components-textfield-stable)                             |
| `size?`                                                                    | `'m'` &#124; `'xs'` &#124; `'s'` &#124; `'l'`                                                                                                                                                                                                               | `'m'`                 | Размер, см. [TextField](##LIBS.STAND\|stand:uikit-components-textfield-stable)                                                  |
| `form?`                                                                    | `'default'` &#124; `'brick'` &#124; `'round'` &#124; `'clearRound'` &#124; `'roundClear'` &#124; `'clearDefault'` &#124; `'defaultClear'` &#124; `'defaultBrick'` &#124; `'brickDefault'` &#124; `'brickClear'` &#124; `'clearBrick'` &#124; `'clearClear'` | `'default'`           | Форма поля, см. [TextField](##LIBS.STAND\|stand:uikit-components-textfield-stable)                                              |
| `view?`                                                                    | `'default'` &#124; `'clear'`                                                                                                                                                                                                                                | `'default'`           | Внешний вид поля, см. [TextField](##LIBS.STAND\|stand:uikit-components-textfield-stable)                                        |
| `status?`                                                                  | `'alert'` &#124; `'success'` &#124; `'warning'`                                                                                                                                                                                                             | -                     | Статус поля, см. [TextField](##LIBS.STAND\|stand:uikit-components-textfield-stable)                                             |
| `onFocus?`                                                                 | `DatePickerPropOnFocus<TYPE>`                                                                                                                                                                                                                               | -                     | Событие по фокусу в поле, см. [TextField](##LIBS.STAND\|stand:uikit-components-textfield-stable)                                |
| `onBlur?`                                                                  | `DatePickerPropOnFocus<TYPE>`                                                                                                                                                                                                                               | -                     | Событие при потере фокуса в поле, см. [TextField](##LIBS.STAND\|stand:uikit-components-textfield-stable)                        |
| `autoFocus?`                                                               | `boolean`                                                                                                                                                                                                                                                   | -                     | Перемещает фокус в поле, см. [TextField](##LIBS.STAND\|stand:uikit-components-textfield-stable)                                 |
| `placeholder?`                                                             | `string`                                                                                                                                                                                                                                                    | -                     | Подсказка в поле, см. [TextField](##LIBS.STAND\|stand:uikit-components-textfield-stable)                                        |
...
| `leftSide?`                                                                | `DatePickerPropSide<TYPE>`                                                                                                                                                                                                                                  | -                     | Иконка или текст слева, внутри поля, см. [TextField](##LIBS.STAND\|stand:uikit-components-textfield-stable)                     |
| `rightSide?`                                                               | `DatePickerPropSide<TYPE>`                                                                                                                                                                                                                                  | -                     | Иконка или текст справа, внутри поля, см. [TextField](##LIBS.STAND\|stand:uikit-components-textfield-stable)                    |
...
| [`renderAdditionalControls?`](##LIBS.STAND|stand:uikit-components-datetime-stable) | `DateTimeAdditionalControlRenderProp`                                                                                                                                                                                                                       | -                     | Дополнительные конторолы для выбора даты                                                                               |
