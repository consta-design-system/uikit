...
type DatePickerTypeDateProps = React.ComponentProps<typeof DatePicker<'date'>>;

const renderComponent = (
  ctx: TestContext,
  props: DatePickerTypeDateProps = {},
) => {
  ...
  describe('проверка value', () => {
    ...
    test(`верно отображается в календаре`, (ctx) =>
      context.start(async () => {
        ...
        expect(getDateTimeItemSelected(ctx)).toHaveTextContent('15');
      }));
  });
