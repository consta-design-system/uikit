...
type DatePickerTypeDateTimeProps = React.ComponentProps<
  typeof DatePicker<'date-time'>
>;

const renderComponent = (
  ctx: TestContext,
  props: DatePickerTypeDateTimeProps = {},
) => {
  ...
  describe.concurrent('проверка value', () => {
    ...
    test(`верно отображается в календаре`, (ctx) =>
      context.start(async () => {
        ...
        expect(getDateTimeDaySelected(ctx)).toHaveTextContent('15');
