...
Для позиционирования тултипа используется компонент [Popover](##LIBS.LIB.STAND.TAB/lib:uikit/stand:components-popover-stable/tab:dev/hash:способы-позиционирования) и его способы позиционирования.
