...
| `container?`                               | `Element`                                     | `window.document.body`     | Родительский контейнер для тултипа. См. [Popover](##LIBS.LIB.STAND.TAB/lib:uikit/stand:components-popover-stable/tab:dev)                                   |
