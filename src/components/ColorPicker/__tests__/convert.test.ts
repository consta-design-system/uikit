...
describe('convert', () => {
  ...
  describe('hexToRgba', () => {
    it('преобразует 6-значный hex в rgba', () => {
    ...
    it('преобразует 3-значный hex в rgba', () => {
    ...
    it('преобразует 8-значный hex с альфа-каналом', () => {
    ...
    it('преобразует 4-значный hex с альфа-каналом', () => {
    ...
    it('работает без префикса #', () => {
      expect(hexToRgba('ff0000')).toEqual({ r: 255, g: 0, b: 0, a: 1 });
    });
  });

  describe('hexToHsva', () => {
    it('преобразует hex в hsva', () => {
  ...
  describe('hexToHsvaRound', () => {
    it('преобразует hex в hsva с округлением', () => {
  ...
  describe('hsvaToHex', () => {
    ...
    it('преобразует hsva с альфа-каналом в hex с альфа-каналом', () => {
  ...
  describe('rgbaToHex', () => {
    ...
    it('преобразует rgba с альфа-каналом в hex с альфа-каналом', () => {
  ...
  describe('hslaStringToHsva', () => {
    it('преобразует строку hsl в hsva', () => {
    ...
    it('преобразует строку hsla в hsva', () => {
    ...
    it('обрабатывает разные единицы измерения hue', () => {
  ...
  describe('hsvaStringToHsva', () => {
    it('преобразует строку hsv в hsva', () => {
    ...
    it('преобразует строку hsva в hsva', () => {
  ...
  describe('rgbaStringToHsva', () => {
    it('преобразует строку rgb в hsva', () => {
    ...
    it('преобразует строку rgba в hsva', () => {
  ...
  describe('hsvaToHsvRound', () => {
    it('удаляет альфа-канал и округляет', () => {
  ...
  describe('rgbaToHsvaRound', () => {
    it('преобразует rgba в hsva с округлением', () => {
  ...
  describe('hsvaStringToHsvaRound', () => {
    it('преобразует строку hsva в hsva с округлением', () => {
      expect(
