...
Используйе поля ввода с обоих сорон только в применением модификации `range`
...
| [`tooltipFormatter?`](#кастомная-подсказка)            | `SliderPropToolipFormatter`                                               | -            | Метод для форматирования текста в тултипе        |
