...
- [Значения на ползунке](#значения-на-ползунке)
  ...
  - [Ограничение значений, которые можно выбрать](#ограничение-значений-которые-можно-выбрать)
- [Тексты](#тексты)
  - [Тултип с подсказкой](#тултип-с-подсказкой)
  - [Лейбл и подпись](#лейбл-и-подпись)
- [Дополнительные элементы слева и справа](#дополнительные-элементы-слева-и-справа)
...
Вы можете ограничить значения, которые может выбрать пользователь: указать **шаг для движения ползунка** или передать **набор значений**. За это отвечает свойство `steps`.
...
### Дополнительные элементы слева и справа
...
| [`leftSide?`](#дополнительные-элементы-слева-и-справа)  | `PropSide`                                      | -            | Элемент слева от компонента                      |
| [`rightSide?`](#дополнительные-элементы-слева-и-справа) | `PropSide`                                      | -            | Элемент справа от компонента                     |
