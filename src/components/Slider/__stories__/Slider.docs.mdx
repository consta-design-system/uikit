...
| [`leftSide?`](#дополнительные-элементы)        | `'input'`                                       | -            | Элемент отображаемый слева от компонента         |
| [`rightSide?`](#дополнительные-элементы)       | `'React.FC<IconProps>'`                         | -            | Элемент отображаемый справа от компонента        |
