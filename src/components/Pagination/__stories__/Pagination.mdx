...
Компонент может выравниваться по горизонтали: слева, по центру, справа. Позиционируется по центру при включенном `minified`.
...
`minified` скрывает кнопки переключения между страницами вперёд/назад. Они появляются при наведении на компонент пагинации.
