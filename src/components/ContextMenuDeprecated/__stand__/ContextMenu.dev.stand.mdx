...
| `anchorRef`                                                        | `React.RefObject<HTMLElement>`                                         | -                | см. [Popover](##LIBS.STAND.TAB/tab:dev/stand:uikit--components--popover--stable/hash:по-координатам)                                                        |
| `position`                                                         | `{ x: number; y: number }, undefined`                                  | -                | см. [Popover](##LIBS.STAND.TAB/tab:dev/stand:uikit--components--popover--stable/hash:по-координатам)                                                        |
| `direction?`                                                       | `Direction`                                                            | -                | см. [Popover](##LIBS.STAND.TAB/tab:dev/stand:uikit--components--popover--stable/hash:по-координатам)                                                        |
| `possibleDirections?`                                              | `Direction`                                                            | -                | см. [Popover](##LIBS.STAND.TAB/tab:dev/stand:uikit--components--popover--stable/hash:по-координатам)                                                        |
| `offset?`                                                          | `PopoverPropOffset`                                                    | -                | см. [Popover](##LIBS.STAND.TAB/tab:dev/stand:uikit--components--popover--stable/hash:по-координатам)                                                        |
