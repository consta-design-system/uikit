...
- `time` — позволяет время (показывает одно поле ввода),
...
| [`type?`](#тип-дата-или-период)                                            | `'date', 'date-range', 'date-time', 'date-time-range', 'time'`                                                                                                      | `date`                | Тип календаря: выбор даты или выбор периода                                                                            |
