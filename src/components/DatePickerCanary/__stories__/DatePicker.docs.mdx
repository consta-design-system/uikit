...
| `calendarView?`        | `'classic'`, `'book'`, `'slider'`                                                                                                                                   | `'classic'`           | Вид календаря, см. [DateTime](/?path=/docs/components-datetime--playground)                          |
...
| `calendarForm?`        | `'default', 'brick', 'round'`                                                                                                                                       | `'default'`           | Форма календаря                                                                                      |
