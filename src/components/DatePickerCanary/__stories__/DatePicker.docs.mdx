...
import { DatePickerExampleAdaptive } from './examples/DatePickerExampleAdaptive/DatePickerExampleAdaptive';
...
Поле ввода подстраивается под ширину контейнера или экрана. Размеры всплывающего окна не меняются.

##### Пример компонента в контейнере шириной 300 px

<DatePickerExampleAdaptive />
