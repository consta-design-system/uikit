...
const getLabel = () =>
  getRender().querySelector(`.${cnSwitch('Label')}`) as HTMLSpanElement;
  ...
  describe('проверка sizes', () => {
    sizes.forEach((size) => {
      it(`size ${size} должен быть отображен`, () => {
        ...
        expect(getRender()).toHaveClass(cnSwitch({ size }));
      });
    });
  });
  ...
  describe('проверка views', () => {
    views.forEach((view) => {
      it(`view ${view} должен быть отображен`, () => {
        ...
        expect(getRender()).toHaveClass(cnSwitch({ view }));
      });
    });
  });
  ...
  describe('проверка align', () => {
    aligns.forEach((align) => {
      it(`align ${align} должен быть отображен`, () => {
        ...
        expect(getRender()).toHaveClass(cnSwitch({ align }));
      });
    });
  });
});
