...
import { cnMixList, List } from '@consta/uikit/ListCanary';
...
function ListExampleItems() {
  return <List items={items} className={cnMixList({})} />;
}
```
...
function ListExampleGroups() {
  return <List items={items} className={cnMixList({})} groups={groups} />;
}
```
...
const ListExampleSize = () => {
  return (
    <>
      ...
      <div>
        <Text>s</Text>
        <List items={items} className={cnMixList({})} size="s" />
      </div>
      <div>
        <Text>m</Text>
        <List className={cnMixList({})} items={items} size="m" />
      </div>
      <div>
        <Text>l</Text>
        <List className={cnMixList({})} items={items} size="l" />
      </div>
    </>
  );
};
...
const ListExampleForm = () => {
  return (
    <>
      <div>
        <Text>default</Text>
        <List className={cnMixList({})} items={items} form="default" />
      </div>
      <div>
        <Text>round</Text>
        <List className={cnMixList({})} items={items} form="round" />
      </div>
      <div>
        <Text>brick</Text>
        <List className={cnMixList({})} items={items} form="brick" />
      </div>
    </>
  );
};
...
function ListExampleDisabled() {
  return <List items={items} disabled className={cnMixList({})} />;
}
```
