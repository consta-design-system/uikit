...
describe.concurrent('getPositionsByDirection', () => {
  ...
  test('возвращает позиции по направлениям относительно якоря', () => {
    const result = getPositionsByDirection({
      contentSize: { width: 100, height: 50 },
  ...
  test('возвращает позиции по направлениям относительно якоря, когда якорь шире контента', () => {
    const result = getPositionsByDirection({
      contentSize: { width: 100, height: 50 },
  ...
  test('возвращает позиции по направлениям относительно якоря со сдвигом стрелки', () => {
    const result = getPositionsByDirection({
      contentSize: { width: 100, height: 50 },
      anchorSize: { width: 20, height: 20 },
      position: { x: 300, y: 500 },
...
describe.concurrent('getComputedPositionAndDirection', () => {
  ...
  describe.concurrent('если есть список запрещенных сторон', () => {
    ...
    test('если все стороны под запретом, то возвращаем направление spareDirection', () => {
      expect(
        getComputedPositionAndDirection({
          viewportSize: { width: 50, height: 500 },
          contentSize: { width: 100, height: 50 },
