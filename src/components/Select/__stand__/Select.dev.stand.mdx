...
| [`labelForEmptyItems?`](#содержимое)                                    | `string`                                                                                                                                                          | `Список пуст`             | Текст, если список пуст                           |
| [`onBlur?`](#поведение)                                                 | `(event?: React.FocusEvent<HTMLInputElement>) => void`                                                                                                            | -                         | Обработчик события `blur`                         |
| [`onFocus?`](#поведение)                                                | `(event?: React.FocusEvent<HTMLInputElement>) => void`                                                                                                            | -                         | Обработчик события `focus`                        |
| [`ariaLabel?`](#поведение)                                              | `string`                                                                                                                                                          | -                         | `aria` атрибут для поля ввода                     |
| [`name?`](#поведение)                                                   | `string`                                                                                                                                                          | -                         | Имя поля ввода                                    |
