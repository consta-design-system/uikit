...
| [`label?`](#лэйбл)                                                 | `string`                                               | -                         | см. [TextField](?path=/docs/components-textfield--playground)          |
| [`labelAlign?`](#лэйбл)                                            | `'top', 'left'`                                        | `'top'`                   | см. [TextField](?path=/docs/components-textfield--playground)          |
| [`caption?`](#подпись)                                             | `string`                                               | -                         | см. [TextField](?path=/docs/components-textfield--playground)          |
