...
| [`getItemLabel?`](#свои-тип-данных-items-и-groups)        | `PropGetItemLabel<ITEM>`                               | -            | Ё                                                |
| [`getItemKey?`](#свои-тип-данных-items-и-groups)          | `PropGetItemKey<ITEM>`                                 | -            | Ё                                                |
| [`getItemGroupKey?`](#свои-тип-данных-items-и-groups)     | `PropGetItemGroupKey<ITEM>`                            | -            | Ё                                                |
| [`getItemDisabled?`](#свои-тип-данных-items-и-groups)     | `PropgetItemDisabled<ITEM>`                            | -            | Ё                                                |
| [`getGroupLabel?`](#свои-тип-данных-items-и-groups)       | `PropGetGroupKey<GROUP>`                               | -            | Ё                                                |
| [`getGroupKey?`](#свои-тип-данных-items-и-groups)         | `PropGetGroupLabel<GROUP>`                             | -            | Ё                                                |
