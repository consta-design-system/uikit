...
import { SelectExampleLabel } from './examples/SelectExampleLabel/SelectExampleLabel';
...
свойство `labelAlign`. Подпись можно добавить через свойство `caption`.
...
| [`labelAlign?`](#лэйбл-и-подпись)                                  | `'top', 'left'`                                        | `'top'`                   | Положение лэйбла                                                       |
