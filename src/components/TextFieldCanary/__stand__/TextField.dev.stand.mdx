...
import {
  ...
  TextFieldExampleMaskArrayEmails,
...
import { TextFieldExampleTextArrayPreParsing } from './examples/TextFieldExampleTextArrayPreParsing/TextFieldExampleTextArrayPreParsing';
...
export const TextFieldExampleMaskArrayEmails = () => {
  ...
  const onChange = (value: string[] | null) => {
    if (value?.length && value[value.length - 1].length === mask.length) {
      setValue(value);
      setError('');
...
| ----------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------ | -------------------------------------------------------------------------------------------------------------------------------------------- |
| [`type?`](#тип-поля)                                  | `'text'` <code>&#124;</code> `'textarea'` <code>&#124;</code> `'number'` <code>&#124;</code> `'textarray'`                                                                                                                                                                                                                                                                                                      | `'text'`     | Тип поля                                                                                                                                     |
...
| [`min?`](#шаг-набор-значений-и-диапазон)              | `number`                                                                                                                                                                                                                                                                                                                                                                                                        | -            | Нижняя граница диапазона значений, которые меняются по кнопкам-стрелочкам, в поле с `type=number`                                            |
