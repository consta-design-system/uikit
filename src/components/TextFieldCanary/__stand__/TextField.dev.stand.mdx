...
- [Список свойств](#свойства)
  - [Расширенные типы свойств](#расширенные-типы-свойств)
- [Тип поля](#тип-поля)
...
Вы можете импортировать один общий компонет:
...
| ----------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------- |
| [`type?`](#тип-поля)                                  | `string`                                                                                                                                                                                                                                                                                                                                                                                                        | Тип поля. По умолчанию `text`.                                                                                                                |
...
| [`size?`](#размеры)                                   | `'xs'` <code>&#124;</code> `'s'` <code>&#124;</code> `'m'` <code>&#124;</code> `'l'`                                                                                                                                                                                                                                                                                                                            | Размер шрифта, отступы и высота поля. По умолчанию `m`.                                                                                       |
...
| [`incrementButtons?`](#шаг-набор-значений-и-диапазон) | `boolean`                                                                                                                                                                                                                                                                                                                                                                                                       | Отображать ли кнопки-стрелочки для `type='number'`. По умолчанию `false`.                                                                     |
| [`withClearButton?`](#кнопка-для-очистки-поля)        | `boolean`                                                                                                                                                                                                                                                                                                                                                                                                       | Отображение кнопки-крестик для очистки поля ввода. По умолчанию `false`.                                                                      |
| [`view?`](#внешний-вид)                               | `'default'` <code>&#124;</code> `'clear'`                                                                                                                                                                                                                                                                                                                                                                       | Внешний вид поля. По умолчанию `default`.                                                                                                     |
| [`form?`](#форма)                                     | `'default'` <code>&#124;</code> ` 'brick'` <code>&#124;</code> ` 'round'` <code>&#124;</code> ` 'clearRound'` <code>&#124;</code> ` 'roundClear'` <code>&#124;</code> ` 'clearDefault'` <code>&#124;</code> ` 'defaultClear'` <code>&#124;</code> ` 'defaultBrick'` <code>&#124;</code> ` 'brickDefault'` <code>&#124;</code> `'brickClear'` <code>&#124;</code> ` 'clearBrick'` <code>&#124;</code> ` 'clear'` | Форма поля. По умолчанию `default`.                                                                                                           |
...
Используйте, когда при вставке строки ее нужно сразу разбивать на подстроки и добавлять к `value`. Так, например, когда есть список электронных почт, который при вставке необходимо преобразавать в массив строк и задать `value`.
...
Вы также можете использовать [`FieldGroup`](##LIBS.LIB.STAND/lib:uikit/stand:components-fieldgroup-stable) для автоматической расстановки формы компонентов при их групировке.
...
Значение `TextField` или любого другого `<input/>` меняется через хук со связкой с полем через `ref`. Чтобы указать значение в момент первого рендера, используйте `defaultValue`. Чтобы изменить поле программно, используйтете `setValue` из хука.
