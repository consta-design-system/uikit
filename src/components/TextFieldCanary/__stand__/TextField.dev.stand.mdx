...
Чтобы добавить в поле кнопку, по которой можно очистить его содержимое, используйте свойство `clearButton`. Если в поле есть значение, справа появляется крестик. При нажатии на него поле станет пустым.
...
| [`clearButton?`](#кнопка-для-очистки-поля)            | `boolean`                                                                                                                                                                                                                                                                                                                                                                                                       | -            | Отображение кнопки-крестик для очистки поля ввода.                                                                                            |
...
| `inputValue?`                                         | `string` <code>&#124;</code> `null`                                                                                                                                                                                                                                                                                                                                                                             | -            | Значение `<input>`, работает только с `type='textarray'`.                                                                                     |
| `iconClear?`                                          | `IconComponent`                                                                                                                                                                                                                                                                                                                                                                                                 | -            | Иконка удаления выбранного значения                                                                                                           |
| `iconShowPassword?`                                   | `IconComponent`                                                                                                                                                                                                                                                                                                                                                                                                 | -            | Иконка глазика                                                                                                                                |
| `iconHidePassword?`                                   | `IconComponent`                                                                                                                                                                                                                                                                                                                                                                                                 | -            | Иконка закрытого глазика                                                                                                                      |
