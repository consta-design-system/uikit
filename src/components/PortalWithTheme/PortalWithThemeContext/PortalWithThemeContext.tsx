 ...
 * нужен для того чтобы получать рефы дочерних порталов и прокидывать их в родителькие порталы
 ...
 * компонент думал ччто клик произашел в не еомпонента и срабатывал onOutsideClick.
