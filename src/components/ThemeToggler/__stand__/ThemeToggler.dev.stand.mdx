...
Контекстное меню работает на основе [поповера](##LIBS.STAND.DEV/stand:uikit-components-popover-stable).
...
[Подробнее в описании поповера](##LIBS.STAND.DEV/stand:uikit-components-popover-stable/hash:направление-разворачивания)
...
| [`direction?`](#контекстное-меню)          | `Direction`                    | -              | см. [Popover](##LIBS.STAND.DEV/stand:uikit-components-popover-stable/hash:направление-разворачивания) (только если тем больше двух)                       |
| [`possibleDirections?`](#контекстное-меню) | `Direction[]`                  | -              | см. [Popover](##LIBS.STAND.DEV/stand:uikit-components-popover-stable/hash:направление-разворачивания) (только если тем больше двух)                       |
