...
Контекстное меню работает на основе [поповера](##LIBS.STAND.TAB/tab:dev/stand:uikit--components--popover--stable).
...
[Подробнее в описании поповера](##LIBS.STAND.TAB/tab:dev/stand:uikit-components---popover----stable/hash:направление--разворачивания)
...
| [`direction?`](#контекстное-меню)          | `Direction`                    | -              | см. [Popover](##LIBS.STAND.TAB/tab:dev/stand:uikit--components--popover--stable/hash:направление-разворачивания) (только если тем больше двух)            |
| [`possibleDirections?`](#контекстное-меню) | `Direction[]`                  | -              | см. [Popover](##LIBS.STAND.TAB/tab:dev/stand:uikit--components--popover--stable/hash:направление-разворачивания) (только если тем больше двух)            |
