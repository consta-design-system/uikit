...
```tsx
import { ProgressStepBar } from '@consta/ProgressStepBarCanary';
```
...
import { IconDinosaur } from '@consta/icons/IconDinosaur/IconDinosaur';
import { IconSettings } from '@consta/icons/IconSettings/IconSettings';
import { Tag } from '@consta/Tag/Tag';
import { ProgressStepBar } from '@consta/ProgressStepBarCanary';
...
```tsx
import { ProgressStepBar } from '@consta/DatePickerCanary';
```
