...
```tsx
type StepsPropOnChange<ITEM> = (props: { e: React.MouseEvent; value: ITEM }) => void;
...
| [`getItemDisabled?`](#недоступные-шаги) | `StepsPropGetDisabled`  | —            | Получает флаг недоступен ли шаг                                                      |
| [`getItemCompleted?`](#пройденные-шаги) | `StepsPropGetSkipped`   | —            | Получает флаг завершен ли шаг                                                        |
| [`getItemSkipped?`](#пропущенные-шаги)  | `StepsPropGetCompleted` | —            | Получает флаг пропущен ли шаг                                                        |
