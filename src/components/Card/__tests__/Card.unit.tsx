...
describe.concurrent('компонент Card', () => {
  ...
  describe.concurrent('проверка verticalSpace', () => {
  ...
  describe.concurrent('проверка horizontalSpace', () => {
  ...
  describe.concurrent('проверка border', () => {
  ...
  describe.concurrent('проверка shadow', () => {
