...
Может лучше так: Есть три размера — `xs`, `s` и `m`. Основной размер m, включен по умолчанию.
...
| [`getItemLabel?`](#текст-для-таба)             | `(item: ITEM) => string, number`                                                | -            | Функция для формирования текста таба. Используется в качестве уникального ключа элемента                                                                                             |
| [`getItemLeftIcon?`](#иконки)                  | `(item: ITEM) => IconComponent, undefined`                                      | -            | Функция для формирования иконки слева                                                                                                                                                |
| [`getItemRightIcon?`](#иконки)                 | `(item: ITEM) => IconComponent, undefined`                                      | -            | Функция для формирования иконки справа                                                                                                                                               |
| [`getItemLeftSide?`](#дополнительный-контент)  | `(item: ITEM) => React.ReactNode, undefined`                                    | -            | Функция для формирования дополнительного контента слева                                                                                                                              |
| [`getItemRightSide?`](#дополнительный-контент) | `(item: ITEM) => React.ReactNode, undefined`                                    | -            | Функция для формирования дополнительного контента справа                                                                                                                             |
| [`getItemDisabled?`](#неактивные-элементы)     | `(item: ITEM) => boolean, undefined`                                            | -            | Функция указывает на состояние активности элемента                                                                                                                                   |
| [`getItemAs?`](#рендеринг)                     | `(item: ITEM) => keyof JSX.IntrinsicElements, undefined`                        | -            | Функция для получения HTML-тега, которым будет отрисовываться элемент                                                                                                                |
| [`getItemAttributes?`](#рендеринг)             | `(item: ITEM) => JSX.IntrinsicElements[keyof JSX.IntrinsicElements], undefined` | -            | Функция для получения HTML-атрибутов, которые используются в элементе                                                                                                                |
| `getItemRef?`                                  | `(item: ITEM) => React.RefObject<HTMLElement>, undefined`                       | -            | Функция для получения ссылки на элемент                                                                                                                                              |
...
| [`linePosition?`](#расположение-табов-и-линии) | `'bottom', 'top', 'left', 'right'`                                              | `'bottom'`   | Расположение табов (вертикальных или горизонатальных) и линии, которая отмечает активный таб                                                                                         |
