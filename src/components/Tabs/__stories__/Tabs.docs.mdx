...
import { TabsExampleAdaptive } from './examples/TabsExampleAdaptive/TabsExampleAdaptive';
...
Табы подстраиваются под доступную им ширину — невместившиеся табы перемещаются в выпадающий список.
