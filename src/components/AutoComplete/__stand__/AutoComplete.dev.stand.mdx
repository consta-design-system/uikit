...
Компонент выглядит, как обычное поле ввода. Если в этом поле что-то напечатать, компонент найдёт все подсказки, в названии которых есть напечатанные символы и покажет их в выпадающем списке.
...
| `isLoading?`                                                                                                    | `boolean`                                                                                                                                                           | -                                                                                    | Отображает индикатор загрузки при загрузке                                                                                                   |
...
| `onScrollToBottom?`                                                                                             | `() => void;`                                                                                                                                                       | -                                                                                    | Колбэк сработает при прокрутки до конца списка                                                                                               |
