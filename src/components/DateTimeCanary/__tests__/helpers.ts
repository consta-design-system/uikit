...
export const getTimeItems = () => getRender().querySelectorAll(`.DateTimeTypeTime .DateTimeItem`);
...
export const getDayItems = () => getRender().querySelectorAll(`.DateTimeMonth .DateTimeItem`);
