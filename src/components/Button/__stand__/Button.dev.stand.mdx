...
Если после нажатия на кнопку пользователь ждет какого-то результата, в кнопке можно отобразить лоадер. Для этого используйте свойство `loading`.
...
| [`loading`](#лоадер)             | `boolean`                                                                                 | `false`                   | Отображает лоадер вместо кнопки во время загрузки информации                     |
