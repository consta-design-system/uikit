...
Если после нажатия на кнопку пользователь ждет какого-то результата, в кнопке можно отобразить индикатор загрузки. Для этого используйте свойство `loading`.
...
| [`loading`](#индикатор-загрузки) | `boolean`                                                                                 | `false`                   | Отображает индикатор загрузки вместо кнопки во время загрузки информации         |
