...
[Посмотреть иконки для файлов](##LIBS.STAND/stand:uikit--components--icon--stable)
...
Иконку можно выбрать из [библиотеки иконок](##LIBS.STAND/stand:uikit--components--icon--stable).
