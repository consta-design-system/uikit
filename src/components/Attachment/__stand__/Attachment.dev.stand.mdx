...
Компонент `Attachment` используется для отображения прикрепленных файлов в интерфейсе, таких как документы, изображения или другие вложения. Подходит для списков вложений в письмах, формах или файловых менеджерах.

Типичные сценарии использования:

- Показ вложенных файлов в форме отправки.
- Управление загруженными файлами в редакторе.
- Отображение списка документов с возможностью предпросмотра или скачивания.
