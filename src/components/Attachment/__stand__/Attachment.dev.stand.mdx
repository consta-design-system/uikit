...
[Посмотреть иконки для файлов](##LIBS.LIB.STAND/lib:uikit/stand:components-icon-stable)
...
Иконку можно выбрать из [библиотеки иконок](##LIBS.LIB.STAND/lib:uikit/stand:components-icon-stable).
