...
import { CollapseGroupExampleIsAccordion } from '../__stories__/examples/CollapseGroupExampleIsAccordion/CollapseGroupExampleIsAccordion';
import { CollapseGroupExampleOwnType } from '../__stories__/examples/CollapseGroupExampleOwnType/CollapseGroupExampleOwnType';
import { CollapseGroupExampleControl } from '../__stories__/examples/CollapseGroupExampleControl/CollapseGroupExampleControl';
...
Блок внутри группы коллапсов ведёт себя так же, как обычный [Collapse](/##LIBS.STAND|stand:uikit-components-collapse-stable). Вы можете подсветить заголовок по наведению, добавить разделитель, поменять отступы, вывести дополнительный элемент справа от заголовка, поменять иконку, её расположение и направление.

[Подробнее про Collapse](##LIBS.STAND|stand:uikit-components-collapse-stable)
...
| `size?`                                     | `'l', 'm', 's', 'xs', '2xs'`                                                  | `'m'`                     | Размер, см. [Collapse](##LIBS.STAND|stand:uikit-components-collapse-stable)                                              |
| `view?`                                     | `'primary', 'secondary'`                                                      | `'primary'`               | Внешний вид, см. [Collapse](##LIBS.STAND|stand:uikit-components-collapse-stable)                                         |
| `hoverEffect?`                              | `boolean`                                                                     | -                         | Подсвечивает заголовок при наведении, см. [Collapse](##LIBS.STAND|stand:uikit-components-collapse-stable)                |
| `divider?`                                  | `boolean`                                                                     | -                         | Добавляет разделитель между заголовком и содержимым, см. [Collapse](##LIBS.STAND|stand:uikit-components-collapse-stable) |
| `horizontalSpace?`                          | `'6xl', '5xl', '4xl', '3xl', '2xl', 'xl', 'l', 'm', 's', 'xs', '2xs', '3xs'`  | -                         | Устанавливает боковые отступы, см. [Collapse](##LIBS.STAND|stand:uikit-components-collapse-stable)                       |
| `icon?`                                     | `IconComponent`                                                               | `IconComponent`           | Иконка в закрытом состоянии, см. [Collapse](##LIBS.STAND|stand:uikit-components-collapse-stable)                         |
| `closeIcon?`                                | `IconComponent`                                                               | -                         | Иконка в открытом состоянии, см. [Collapse](##LIBS.STAND|stand:uikit-components-collapse-stable)                         |
| `iconPosition?`                             | `'left', 'right'`                                                             | `'left'`                  | Расположение иконки, см. [Collapse](##LIBS.STAND|stand:uikit-components-collapse-stable)                                 |
| `directionIcon?`                            | `'up', 'right', 'down', 'left', 'upRight', 'downRight', 'upLeft', 'downLeft'` | `'up'`                    | Направление иконки в закрытом состоянии см. [Collapse](##LIBS.STAND|stand:uikit-components-collapse-stable)              |
| `closeDirectionIcon?`                       | `'up', 'right', 'down', 'left', 'upRight', 'downRight', 'upLeft', 'downLeft'` | `'down'`                  | Направление иконки в открытом состоянии, см. [Collapse](##LIBS.STAND|stand:uikit-components-collapse-stable)             |
