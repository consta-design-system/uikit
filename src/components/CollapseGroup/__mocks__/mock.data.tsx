...
export const items: Item[] = [
  {
    ...
    content: (
      <>
        <b>Первый ответ</b> — очень важный и длинный. Это просто информация, которую пользователь
        видит только после того, как нажал на заголовок. Внутри может быть что угодно: текст,
        картинки, форма с вопросами, видео или анимация.
      </>
    ),
    status: 'normal',
  },
  {
    label: 'Второй вопрос',
    content: 'А это просто ответ на второй вопрос. Он вряд ли получится таким длинным, как первый.',
    status: 'error',
  },
  {
    label: 'Третий вопрос',
