...
Вы можете определить собственный текст для каждой, отдельно взятой ошибки.
Чтобы сделать это вам необходимо определить свойство `errorMessages`
...
| [`errorMessages?`](#типы-файлов)            | `DragNDropFieldPropErrorMessages`                                                     | -            | Список кастомных ошибок                                                                                                                       |
