...
export const DragNDropField = forwardRef<HTMLDivElement, DragNDropFieldProps>((props, ref) => {
  ...
  const handleRootClick: React.MouseEventHandler<HTMLDivElement> = React.useCallback((e) => {
