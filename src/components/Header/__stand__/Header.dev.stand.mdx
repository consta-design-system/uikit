...
В основе модуля — компонент [Button](##LIBS.LIB.STAND/lib:uikit/stand:components-button-stable) в модификациях: `view_clear`, `size_m`, `onlyicon`, `form_round` с [иконкой](##LIBS.LIB.STAND/lib:uikit/stand:components-icon-stable) размера `m`.
