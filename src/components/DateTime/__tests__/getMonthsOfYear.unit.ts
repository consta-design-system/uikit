...
describe.concurrent('DateTime/getMonthsOfYear', () => {
  ...
  test('верный результат с minDate и maxDate', () => {
    const result = getMonthsOfYear({
      date: new Date(1970, 0),
      locale: ru,
  ...
  test('верный результат с events', () => {
    const result = getMonthsOfYear({
      date: new Date(1970, 0),
      locale: ru,
      events: [
  ...
  test('верный результат с value:Date', () => {
    const result = getMonthsOfYear({
      date: new Date(1970, 0),
      locale: ru,
  ...
  test('верный результат с value:DateRange', () => {
    const result = getMonthsOfYear({
      date: new Date(1970, 0),
      locale: ru,
  ...
  test('верный результат с locale = en-US', () => {
    const result = getMonthsOfYear({
      date: new Date(1970, 0),
      locale: enUS,
    });
  ...
  test('верный результат с множеством данных', () => {
    const result = getMonthsOfYear({
      date: new Date(1970, 0),
      locale: ru,
