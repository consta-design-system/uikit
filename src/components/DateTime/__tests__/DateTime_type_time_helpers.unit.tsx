...
describe('getFirstValidDateTime', () => {
  ...
  test('пропускает час если нет валидных часов (minDate)', () => {
  ...
  test('пропускает час и минуту если нет валидных минут (minDate)', () => {
  ...
  test('пропускает час минуту и секунду если нет валидных секунд (minDate)', () => {
  ...
  test('работает с minDate ограничениями - пропускает недоступные часы', () => {
  ...
  test('работает с minDate ограничениями - находит первый доступный час', () => {
  ...
  test('работает с minDate ограничениями - учитывает минуты в minDate', () => {
  ...
  test('работает с minDate ограничениями - пропускает час если все минуты недоступны', () => {
  ...
  test('работает с maxDate ограничениями - обрезает доступные часы', () => {
  ...
  test('работает с maxDate ограничениями - не находит валидной даты если все часы недоступны', () => {
  ...
  test('работает с minDate и maxDate одновременно', () => {
  ...
  test('работает с minDate/maxDate и ограниченными минутами', () => {
  ...
  test('работает с disableDates - пропускает отключенные даты (одиночные даты)', () => {
  ...
  test('работает с disableDates - пропускает отключенные диапазоны', () => {
    const disableDates: DateTimePropDisableDates = [
  ...
  test('работает с disableDates - пропускает час если все минуты в отключенном диапазоне', () => {
    const disableDates: DateTimePropDisableDates = [
  ...
  test('работает с комбинацией minDate и disableDates', () => {
    const minDate = new Date(1970, 0, 1, 6, 0, 0);
    const disableDates: DateTimePropDisableDates = [
  ...
  test('работает с edge case - minDate позже всех доступных часов', () => {
  ...
  test('работает с edge case - все секунды отключены для первой минуты', () => {
    const disableDates: DateTimePropDisableDates = [
      new Date(1970, 0, 1, 5, 0, 0),
  ...
  test('работает с edge case - сложная комбинация ограничений', () => {
  ...
  test('возвращает startOfDay когда нет ни одного валидного времени', () => {
