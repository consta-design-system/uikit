...
Колбек вызывается, если хотя бы один файл соответствует всем заданным условиям. Если ни один файл не прошел по условиям, вызван не будет. Все файлы, удовлетворяющие условиям, будут собраны в масив объектов типа [`File`](https://developer.mozilla.org/en-US/docs/Web/API/File).
...
- размеры файлов `sizes?: FileSizes`, если ваш компонент ограничивает минимальный и/или максимальный размер загружаемых фалов. В сообщениях об ошибке будет указан нужный размер.
