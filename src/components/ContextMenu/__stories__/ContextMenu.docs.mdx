...
| `onClick?`                                                         | `({e: React.MouseEvent<HTMLDivElement>, item: ITEM}) => void`          | -                | Действие по клику на пункт меню                                                                                                                             |
...
| `getOnItemClick?`                                                  | `(item: ITEM) => React.EventHandler<React.MouseEvent<HTMLDivElement>>` | -                | Действие по клику на пункт меню                                                                                                                             |
