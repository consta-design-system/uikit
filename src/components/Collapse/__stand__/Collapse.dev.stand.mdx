...
Внутренние боковые отступы между текстом и границами компонента можно регулировать с помощью `horizontalSpace`. Варианты: `'6xl'`, `'5xl'`, `'4xl'`, `'3xl'`, `'2xl'`, `'xl'`, `'l'`, `'m'`, `'s'`, `'xs'`, `'2xs'`, `'3xs'`. По умолчанию 0.
