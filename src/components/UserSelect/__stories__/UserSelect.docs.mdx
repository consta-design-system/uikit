...
| `labelForEmptyItems?`                                               | `string`                                               | `Список пуст`                                                 | Текст отображаемый при пустом списке значений                          |
| [`labelForNotFound?`](#поиск)                                       | `string`                                               | `Не найдено`                                                  | Текст для случая, когда при поиске ничего не найдено                   |
| [`labelForCreate?`](#создание-новых-пользователей)                  | `string`                                               | `+`                                                           | Текст для добавления нового элемента                                   |
