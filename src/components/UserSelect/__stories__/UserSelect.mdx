...
| [`getOptionSubLabel?`](#варианты)       | `(arg: T) => string`                                   | -            | Функция для получения текста варианта, который будет отображаться в поле дополнительной информации для выбранного значения |
| [`getOptionUrl?`](#варианты)            | `(arg: T) => string`                                   | -            | Функция для получения url изображения, которое будет отображаться в аватаре пользователя                                   |
