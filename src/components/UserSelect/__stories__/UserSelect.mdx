...
| --------------------------------------- | ------------------------------------------------------ | ------------ | -------------------------------------------------------------------------------------------------------------------------- |
| `multi?`                                | `boolean`                                              | `true`       | Возможность выбрать несколько варинтов                                                                                     |
...
| [`getUserAdditionalInfo?`](#варианты)   | `(arg: T) => string`                                   | -            | Функция для получения текста варианта, который будет отображаться в поле дополнительной информации для выбранного значения |
| [`getUserUrl?`](#варианты)              | `(arg: T) => string`                                   | -            | Функция для получения url изображения, которое будет отображаться в аватаре пользователя                                   |
