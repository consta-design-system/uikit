...
| `getItemAttributes?`                        | `(item: ITEM) => CheckboxGroupPropAttributes`       | —            | Функция для получения дополнительных атрибутов элемента                                                 |
| `getItemRef?`                               | `(item: ITEM) => React.RefObject<HTMLLabelElement>` | —            | Функция для получения ссылки на чебкокс                                                                 |
