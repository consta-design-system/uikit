...
Так же, чтобы привлечь внимание пользователя на опасность действия, используйте статустные иконки красного цвета с понятными метафорами действия, например, удаление = мусорка или красный крест.
