...
Возможно вкладывать компонеы с всплывающими окнами в модалное окно.
В этом случае все вложенные элемены буду находися выше модалки.
Если указывать `zIndex` через свойсво `style`, то все вложенные всплывающие окна получат `zIndex + 1`
