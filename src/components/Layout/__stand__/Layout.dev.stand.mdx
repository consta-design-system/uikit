...
| [`anchorRef`](#прикрепление-к-якорю)      | `React.RefObject<HTMLElement>`        | -            | см. [Popover](##LIBS.STAND.TAB/tab:dev/stand:uikit--components--popover--stable/hash:по-элементу-якорю) |
