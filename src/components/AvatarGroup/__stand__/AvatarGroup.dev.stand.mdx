...
Количество отображаемых аватаров можно указать в свойстве `visibleCount`, по умолчанию оно равно `4`. Если указать 'auto', то количество аватарок будет подстраиваться под ширину компонента.
