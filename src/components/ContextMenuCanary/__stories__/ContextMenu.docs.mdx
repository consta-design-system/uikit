...
- `disabled` - [активен ли пункт меню](#заблокировать).
- `groupId` - идентификатор [группы к которой относится пункт](#группы).
- `onClick` - функция, которая вызывается при нажатии на пункт меню.
- `as` - то, каким образом будет отрисовываться пункт меню.
- `attributes` - HTML атрибуты, используемые в пункте меню.

## Текст пункта

Добавить текст пункта меня можно в атрибуте `label` в свойстве `items` типа [ContextMenuItemDefault](#свойства).
Если используете кастомный тип, получить сообщение можно с помощью функции `getItemLabel`.
...
Чтобы заблокировать пункт меню нужно использовать атрибут `disabled` в свойстве `items` типа [ContextMenuItemDefault](#свойства).
Если используете кастомный тип, получить флаг можно с помощью функции `getItemDisabled`.
...
Чтобы добавить что-то слева от названия пункта меню, используйте `leftSide`, а справа `rightSide`.
...
Для того чтобы привязать пункт меню к группе необходимо указать атрибут `groupId`
в свойстве `items` типа [ContextMenuItemDefault](#свойства) или если вы используете кастомный тип,
получить идентификатор группы можно с помощью функций `getItemGroupId`.
Если используете кастомный тип, получить идентификатор и название группы можно с помощью
...
| [`groups`](#группы-пунктов)                                        | `GROUP[]`                                                                                                           | -                | Группы меню                                                                                                                                                     |
| `anchorRef`                                                        | `React.RefObject<HTMLElement>`                                                                                      | -                | см. [Popover](?path=/docs/components-popover--popover-positioned-by-coords-story)                                                                               |
| `isOpen?`                                                          | `booelan`                                                                                                           | -                | Флаг отвечающий открыто меню или нет                                                                                                                            |
| `zIndex?`                                                          | `number`                                                                                                            | -                | Положение меню по оси Z                                                                                                                                         |
...
| [`size?`](#размер-меню)                                            | `'xs'`<code>&#124;</code>`'m'`<code>&#124;</code>`'s'`<code>&#124;</code>`'l'`                                      | `'m'`            | Размер контекстного меню                                                                                                                                        |
| `getItemKey?`                                                      | `(item: ITEM) => string`<code>&#124;</code>`number`<code>&#124;</code>`undefined`                                   | -                | Результат функции используется в качестве уникального ключа для пункта меню                                                                                     |
...
| [`getItemSubItems?`](#второй-уровень-меню)                         | `(item: ITEM) => ITEM[]`<code>&#124;</code>`undefined`                                                              | -                | Результат функции используется как пункты меню второго уровня                                                                                                   |
| [`getItemStatus?`](#статус)                                        | `(item: ITEM) => 'alert'`<code>&#124;</code>`'warning'`<code>&#124;</code>`'success'`<code>&#124;</code>`undefined` | -                | Результат функции используется как статус пункта меню                                                                                                           |
| `getItemOnClick?`                                                  | `(item: ITEM) => React.EventHandler<React.MouseEvent<HTMLDivElement>>`<code>&#124;</code>`undefined`                | -                | Действие по клику на пункт меню                                                                                                                                 |
| `getItemAs?`                                                       | `(item: ITEM) => keyof JSX.IntrinsicElements`<code>&#124;</code>`undefined`                                         | -                | Результат функции возвращает то, каким образом будет отрисовываться пункт меню                                                                                  |
| `getItemAttributes?`                                               | `(item: ITEM) => JSX.IntrinsicElements[keyof JSX.IntrinsicElements]`<code>&#124;</code>`undefined`                  | -                | Результат функции возвращает HTML атрибуты, используемые в пункте меню                                                                                          |
| `getItemGroupId?`                                                  | `(item: ITEM) => number`<code>&#124;</code>`undefined`                                                              | -                | Результат функции возвращает идентификатор группы к которой относится пункт меню                                                                                |
| [`getItemDisabled?`](#заблокировать-пункт-меню)                    | `(item: ITEM) => boolean`<code>&#124;</code>`undefined`                                                             | -                | Функция, которая блокирует пункт меню. При значении `false` события пункта меню отключаются                                                                     |
| [`getItemLeftIcon?`](#иконка)                                      | `(item: ITEM) => IconComponent`<code>&#124;</code>`undefined`                                                       | -                | Результат функции будет использоваться как иконка слева от названия пункта меню                                                                                 |
| [`getItemRightIcon?`](#иконка)                                     | `(item: ITEM) => IconComponent`<code>&#124;</code>`undefined`                                                       | -                | Результат функции будет использоваться как иконка справа от названия пункта меню                                                                                |
| [`getItemLeftSideBar?`](#добавить-дополнительные-элементы)         | `(item: ITEM) => React.ReactNode`<code>&#124;</code>`undefined`                                                     | -                | Результат функции будет использоваться как рендер слева от названия пункта меню                                                                                 |
| [`getItemRightSide?`](#добавить-дополнительные-элементы)           | `(item: ITEM) => React.ReactNode`<code>&#124;</code>`undefined`                                                     | -                | Результат функции будет использоваться как рендер справа от названия пункта меню                                                                                |
...
| [`getGroupId?`](#группы-пунктов)                                   | `(group: GROUP) => number`                                                                                          | -                | Результат функции используется в качестве ключа группы                                                                                                          |
| [`getGroupLabel?`](#группы-пунктов)                                | `(group: GROUP) => string`<code>&#124;</code>`undefined`                                                            | -                | Результат функции используется как заголовок группы                                                                                                             |
