...
| `anchorRef`                                                    | `React.RefObject<HTMLElement>`                                                                                      | -                | Элемент, относительно которого будет позиционироваться меню, см. [Popover](?path=/docs/components-popover--popover-positioned-by-coords-story)                               |
| `isOpen?`                                                      | `boolean`                                                                                                           | -                | Показывает, нужно раскрывать меню или нет                                                                                                                                    |
| `position`                                                     | `{ x: number; y: number }, undefined`                                                                               | -                | Координаты точки, к которой прикрепляется меню (обязательны, если не заполнено anchorRef), см. [Popover](?path=/docs/components-popover--popover-positioned-by-coords-story) |
| `direction?`                                                   | [`Direction`](#свойства)                                                                                            | -                | Основное направление для разворачивания меню, см. [Popover](?path=/docs/components-popover--popover-positioned-by-coords-story)                                              |
| `possibleDirections?`                                          | [`Direction`](#свойства)                                                                                            | -                | Дополнительные направления, в которые может разворачиваться меню, см. [Popover](?path=/docs/components-popover--popover-positioned-by-coords-story)                          |
| `offset?`                                                      | `PopoverPropOffset`                                                                                                 | -                | Отступ от якоря или позиции, см. [Popover](?path=/docs/components-popover--popover-positioned-by-coords-story)                                                               |
...
| [`getItemStatus?`](#статус-пунка-меню)                         | `(item: ITEM) => 'alert'`<code>&#124;</code>`'warning'`<code>&#124;</code>`'success'`<code>&#124;</code>`undefined` | -                | Результат функции используется как статус пункта меню                                                                                                                        |
...
| `getItemAttributes?`                                           | `(item: ITEM) => JSX.IntrinsicElements[keyof JSX.IntrinsicElements]`<code>&#124;</code>`undefined`                  | -                | Результат функции возвращает HTML-атрибуты, которые используются в пункте меню                                                                                               |
...
| [`getItemLeftSide?`](#добавить-дополнительные-элементы)        | `(item: ITEM) => React.ReactNode`<code>&#124;</code>`undefined`                                                     | -                | Результат функции будет использоваться как рендер слева от названия пункта меню                                                                                              |
...
| [`getGroupLabel?`](#группы-пунктов-меню)                       | `(group: GROUP) => string`<code>&#124;</code>`undefined`                                                            | -                | Результат функции используется как заголовок группы                                                                                                                          |
