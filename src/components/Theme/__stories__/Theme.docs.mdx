...
[Посмотреть на GitHub](https://github.com/gazprom-neft/consta-uikit/tree/master/src/components/Theme)
...
> - Модификатор: `_color`
> - CSS:
>   - [\_color / Theme_color_gpnDark.css](https://github.com/gazprom-neft/consta-uikit/blob/master/src/components/Theme/_color/Theme_color_gpnDark.css)
>   - [\_color / Theme_color_gpnDefault.css](https://github.com/gazprom-neft/consta-uikit/blob/master/src/components/Theme/_color/Theme_color_gpnDefault.css)
>   - [\_color / Theme_color_gpnDisplay.css](https://github.com/gazprom-neft/consta-uikit/blob/master/src/components/Theme/_color/Theme_color_gpnDisplay.css)
...
[Посмотреть на GitHub](https://github.com/gazprom-neft/consta-uikit/blob/master/src/components/Theme/_color/Theme_color_gpnDefault.css)
...
> - Модификатор: `_font`
> - CSS: [\_font / Theme_font_gpnDefault.css](https://github.com/gazprom-neft/consta-uikit/blob/master/src/components/Theme/_font/Theme_font_gpnDefault.css)
...
[Посмотреть на GitHub](https://github.com/gazprom-neft/consta-uikit/blob/master/src/components/Theme/_font/Theme_font_gpnDefault.css)
...
> - Модификатор: `_size`
> - CSS: [\_size / Theme_size_gpnDefault.css](https://github.com/gazprom-neft/consta-uikit/blob/master/src/components/Theme/_size/Theme_size_gpnDefault.css)
...
[Посмотреть на GitHub](https://github.com/gazprom-neft/consta-uikit/blob/master/src/components/Theme/_size/Theme_size_gpnDefault.css)

### Отступы

> - Модификатор: `_space`
> - CSS: [\_size / Theme_space_gpnDefault.css](https://github.com/gazprom-neft/consta-uikit/blob/master/src/components/Theme/_space/Theme_space_gpnDefault.css)
...
[Посмотреть на GitHub](https://github.com/gazprom-neft/consta-uikit/blob/master/src/components/Theme/_space/Theme_space_gpnDefault.css)

### Внешний вид контролов

> - Модификатор: `_control`
> - CSS: [\_control / Theme_control_gpnDefault.css](https://github.com/gazprom-neft/consta-uikit/blob/master/src/components/Theme/_control/Theme_control_gpnDefault.css)
...
[Посмотреть на GitHub](https://github.com/gazprom-neft/consta-uikit/blob/master/src/components/Theme/_control/Theme_control_gpnDefault.css)

### Тени

> - Модификатор: `_shadow`
> - CSS: [\_shadow / Theme_shadow_gpnDefault.css](https://github.com/gazprom-neft/consta-uikit/tree/master/src/components/Theme/_shadow)
...
[Посмотреть на GitHub](https://github.com/gazprom-neft/consta-uikit/tree/master/src/components/Theme/_shadow)
...
Эти пресеты описаны в отдельных файлах, в папке [`presets`](https://github.com/gazprom-neft/consta-uikit/tree/master/src/components/Theme/presets).
...
[Посмотреть на GitHub](https://github.com/gazprom-neft/consta-uikit/blob/master/src/components/Theme/presets/presetGpnDefault.ts)
...
Некоторые компоненты нужно вынести на другой информационный слой, но так, чтобы не перекрывать остальной интерфейс. Например, [Tooltip](https://consta-uikit.vercel.app/?path=/story/components-tooltip--tooltip-positioned-by-anchor-story).
