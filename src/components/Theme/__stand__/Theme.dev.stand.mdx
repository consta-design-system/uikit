...
- [Пресеты](#пресеты)
  ...
  - [Кастомный пресет](##LIBS.LIB.STAND/lib:uikit/stand:theme-createpreset)
...
>
> [Посмотреть варианты насыщенности в компоненте `Text`](##LIBS.LIB.STAND.TAB/lib:uikit/stand:components---text--stable/tab:dev/hash:насыщенность).
...
[Как создать свой пресет](##LIBS.LIB.STAND/lib:uikit/stand:theme--createpreset)
