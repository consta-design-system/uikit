...
- [Пресеты](#пресеты)
  ...
  - [Кастомный пресет](##LIBS.STAND/stand:uikit-theme-createpreset-stable)
...
```css
--font-primary: 'Segoe UI', -apple-system, BlinkMacSystemFont, 'Roboto', 'Oxygen',
...
>
> [Посмотреть варианты насыщенности в компоненте `Text`](##LIBS.STAND.TAB/tab:dev/stand:uikit-components-text-stable/hash:насыщенность).
...
Некоторые компоненты нужно вынести на другой информационный слой, но так, чтобы не перекрывать остальной интерфейс. Например, [Tooltip](##LIBS.STAND/stand:uikit-components-tooltip-stable).
...
компоненты, на которые пользователю стоит обратить внимание: [Snackbar](##LIBS.STAND/stand:uikit-components-snackbar-stable),
[Informer](##LIBS.STAND/stand:uikit-components-informer-stable)
и [Badge](##LIBS.STAND/stand:uikit-components-badge-stable).
...
[Как создать свой пресет](##LIBS.STAND/stand:uikit-theme-createpreset-stable)
...
> Чтобы смена тем работала, все значения в CSS нужно задавать переменными, а переменные использовать по смыслу. [Почитать про смысл цветов](##LIBS.STAND/stand:uikit-components-theme-stable/hash:цвета-темы-default)
