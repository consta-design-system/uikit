...
| [`onItemClick?`](#взаимодействие)          | `(item: ITEM, props: { e: React.MouseEvent }) => void` | -            | Событие клика по элементу                        |
| [`onItemRightIconClick?`](#взаимодействие) | `(item: ITEM, props: { e: React.MouseEvent }) => void` | -            | Событие клика по иконки справа                   |
...
Вы можете взять отдельно элемент чипов
