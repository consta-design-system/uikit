...
- `onDropdownOpen` - Колбэк, который отрабатывает каждый раз при открытии/закрытии,
...
| `clearButton?`                             | `boolean`                                                                                                                                                                                                                                                                                                                                                                                                       | -                                                        | Отображение кнопки-крестик для очистки поля ввода.                                                                                            |
...
| `onScrollToBottom?`                        | `() => void;`                                                                                                                                                                                                                                                                                                                                                                                                   | -                                                        | Колбэк сработает при прокрутке до конца списка                                                                                                |
