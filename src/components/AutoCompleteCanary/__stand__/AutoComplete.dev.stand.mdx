...
import { AutoCompleteExampleForm } from './examples/AutoCompleteExampleForm/AutoCompleteExampleForm';
...
По умолчанию компонент ищет по `label` элемента. Вы можете поменять параметры поиска с помощью `searchFunction`.
...
| [`width?`]##LIBS.LIB.STAND/lib:uikit/stand:components-textfield-stable/hash:(#размеры)                          | `'full', 'default'`                                                                                                                                                  | `'default'`                                                   | Ширина поля                                                                                                                                  |
...
| [`labelForNotFound?`](#пример-с-кастомным-элементом-списка-и-своей-функцией-поиска)                             | `string`                                                                                                                                                             | `Не найдено`                                                  | Текст, который нужно показать, если при поиске ничего не нашлось                                                                             |
...
| `dropdownClassName?`                                                                                            | `'default', 'brick', 'round'`                                                                                                                                        | `'default'`                                                   | Форма для выпадающего блока                                                                                                                  |
