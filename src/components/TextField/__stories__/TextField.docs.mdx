...
```tsx
<TextField state="success" placeholder="success" caption="success" />
<TextField state="alert" placeholder="error" caption="error" />
<TextField state="warning" placeholder="warning" caption="warning" />
...
| ------------------------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------ | -------------------------------------------------------------------------------------------------------------------------- |
| [`type?`](#тег-для-поля)                   | `'text', 'textarea', 'number'`                                                                                                                                       | `'text'`     | Тег для текстового поля в DOM                                                                                              |
