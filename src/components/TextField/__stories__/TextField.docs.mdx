...
- `number` — поле для ввода чисел, `<input type="number">`, значение можно менять с помощью кнопок-стрелочек. [Установить шаг](#шаг-набор-значений-и-диапазон) — целое число, на которое стрелочки уменьшают или увеличивают значение, можно в свойстве `step`.
...
| `incrementButtons?`                        | `boolean`                                                                                                                                                            | `true`       | Отображать ли кнопки счетчики для `type='number'`                                                                                            |
| `withClearButton?`                         | `boolean`                                                                                                                                                            | `false`      | Отбражать ли кнопку очистки поля ввода                                                                                                       |
