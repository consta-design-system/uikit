...
отвечает свойство `label`, за его расположение `labelAlign`.

<TextFieldExampleLabel />

```tsx
<TextField placeholder="Top" label="Top" labelAlign="top" />
<TextField placeholder="Left" label="Left" labelAlign="left" />
```
...
| [`labelAlign?`](#лэйбл)                    | `'top', 'left'`                                                                                                                                                      | `'top'`      | Положение лэйбла                                                                                                           |
