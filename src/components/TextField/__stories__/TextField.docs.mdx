...
| [`rightSide?`](#дополнительная-информация) | `React.FC<IconProps>\string`                                                                                                                                         | -            | Иконка или текст справа, внутри поля. Используется при всех `'type'` кроме `type='number'`                                 |
| `value?`                                   | `string`, `null`                                                                                                                                                     | -            | Предустановленный текст в поле                                                                                             |
| `placeholder?`                             | `string`                                                                                                                                                             | -            | Подсказка внутри поля                                                                                                      |
| `id?`                                      | `string`                                                                                                                                                             | -            | ID поля в DOM                                                                                                              |
| `step?`                                    | `string` <code>&#124;</code> `number`                                                                                                                                | `1`          | Данное свойство отвечает за то, на какой шаг будет изменяться число при `type=number`                                      |
