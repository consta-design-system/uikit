...
Для поля ввода с `type=number`, можно указать шаг изменения в виде конкретного числа или
в виде конечных точек
...
| [`step?`](#шаг-изменения)                  | `string` <code>&#124;</code> `number`                                                                                                                                | `1`          | Шаг, на который меняется число в поле по кнопкам-стрелочкам при `type=number`. Целое число                |
| `min?`                                     | `string` <code>&#124;</code> `number`                                                                                                                                | -            | Минимальное значение для поля ввода с `type='number'`                                                     |
| `max?`                                     | `string` <code>&#124;</code> `number`                                                                                                                                | -            | Максимальное значение для поля ввода с `type='number'`                                                    |
