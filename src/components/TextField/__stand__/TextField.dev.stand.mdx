...
| `onChange?`                                           | `(value: string`<code>&#124;</code>`null, params: {e: React.ChangeEvent; id?: string, number; name?: string; value: string`<code>&#124;</code>`null;}) => void;`     | -            | Действие при изменении текстового поля                                                                                                       |
