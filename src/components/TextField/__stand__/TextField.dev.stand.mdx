...
Также вы можете добавить текст или иконку справа от поля ввода. Подходит для числовых полей ввода
...
| [`outsideContent?`](#дополнительная-информация)       | `IconComponent, string`                                                                                                                                              | -            | Иконка или текст справа от поля                                                                                                              |
