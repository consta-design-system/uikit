...
- [Маскированние](#маскирование)
  - [Изменения из вне](#изменения-из-вне)
  - [Примеры](#примеры)
    - [Сумма](#сумма)
    - [Телефон](#телефон)
    - [Паспорт](#паспорт)
...
Также к лейблу можно xдобавить иконку используя свойство `labelIcon`.
...
В случае когда значение `TextField` может меняться из вне (изменения происходят не из поля ввода), необходимо использовать функцию [`IMask.pipe`](https://imask.js.org/guide.html#pipe),
для преобразования значения под формат маски
...
| [`withClearButton?`](#кнопка-для-очистки-поля)        | `boolean`                                                                                                                                                            | `false`      | Отображать ли кнопку-крестик для очистки поля ввода                                                                                          |
