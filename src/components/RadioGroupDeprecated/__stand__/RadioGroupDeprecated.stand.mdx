...
радиокнопки не подойдут. Используйте [CheckboxGroup](##LIBS.STAND/stand:uikit-components-checkboxgroup-stable).
...
используйте [переключатель](##LIBS.STAND/stand:uikit-components-switch-stable).
