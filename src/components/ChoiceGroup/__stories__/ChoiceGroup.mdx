...
import {
  ChoiceGroupExampleOne, ChoiceGroupExampleMultiple
...
Согласуйте текст на кнопка с заголовком и между собой. Так просто лучше читается, а значит, проще понять смысл.
...
import { ChoiceGroup } from '@gpn-design/uikit/ChoiceGroupExampleOne';
