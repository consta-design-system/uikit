...
как в [RadioGroup](##LIBS.STAND/stand:uikit-components-radiogroup-stable).
...
как в [CheckboxGroup](##LIBS.STAND/stand:uikit-components-checkboxgroup-stable).
...
[Switch](##LIBS.STAND/stand:uikit-components-switch-stable) — если в интерфейсе есть место.
...
Если кнопки не помещаются на мобильный экран, можно добавить горизонтальную прокрутку или преобразовать в [RadioGroup](##LIBS.STAND/stand:uikit-components-radiogroup-stable).
