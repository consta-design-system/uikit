...
function FileIconMp4SizeM(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 30 40" {...props}>
      ...
      <path
        fill="#fff"
        d="M19 10h2.5v2h1v-2h.5V9h-.5V7.5h-1V9H20l1-4h-1l-1 3.87V10zm-8.5-2.618a1.494 1.494 0 00-1.7-.209V7H8v5h1V8.5a.5.5 0 011 0V12h1V8.5a.5.5 0 011 0V12h1V8.41l-.003-.002A1.5 1.5 0 0010.5 7.382z"
      />
      <path
        fill="#fff"
        fillRule="evenodd"
