...
function IconFileWavSizeS(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 21 28" {...props}>
      ...
      <path
        fill="#fff"
        d="M5 4H4v3l1 2h1l.5-1L7 9h1l1-2V4H8v3H7V5H6v2H5V4zm10 0h1v3h1V4h1v3l-1 2h-1l-1-2V4z"
      />
      <path
        fill="#fff"
        fillRule="evenodd"
...
export default IconFileWavSizeS;
