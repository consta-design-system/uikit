...
function IconFileWavSizeM(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 30 40" {...props}>
      ...
      <path
        fill="#fff"
        d="M9 6H8v3l1 2h1l.5-1 .5 1h1l1-2V6h-1v3h-1V7h-1v2H9V6zm10 0h1v3h1V6h1v3l-1 2h-1l-1-2V6z"
      />
      <path
        fill="#fff"
        fillRule="evenodd"
...
export default IconFileWavSizeM;
