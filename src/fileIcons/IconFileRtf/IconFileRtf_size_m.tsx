...
function IconFileRtfSizeM(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 30 40" {...props}>
      ...
      <path
        fill="#fff"
        fillRule="evenodd"
        d="M15.05 12c-.34 0-.6-.11-.78-.33-.18-.22-.27-.51-.27-.87V8h-1V7h1V6h1v1h2v1h-2v2.6c0 .147.037.25.11.31.073.06.187.09.34.09H17v1h-1.95zm5.3-6a.374.374 0 00-.26.09.268.268 0 00-.09.21V7h1v1h-1v3h1v1h-3v-1h1V8h-1V7h1v-.9c0-.34.097-.607.29-.8.193-.2.443-.3.75-.3h1.46v1h-1.15z"
        clipRule="evenodd"
      />
      <path
        fill="#fff"
...
export default IconFileRtfSizeM;
