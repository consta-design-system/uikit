...
function IconFileZipSizeM(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 30 40" {...props}>
      ...
      <path
        fill="#fff"
        d="M16 5v1h-1V5h1zm-2 3V7h2v4h1v1h-3v-1h1V8h-1zm-1 4H9v-1l2.5-3H9V7h4v1l-2.32 3H13v1z"
      />
      <path
        fill="#fff"
        fillRule="evenodd"
...
export default IconFileZipSizeM;
