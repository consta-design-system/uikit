...
describe('helper getGroups', () => {
  ...
  test('группировка без массива групп', () => {
  ...
  test('группировка без массива групп и с сортировкой', () => {
    const result = getGroups(
      items,
      getItemGroupKey,
      undefined,
  ...
  test('группировка c массивом групп', () => {
    const result = getGroups(
      items,
      getItemGroupKey,
      groups,
  ...
  test('группировка c массивом групп и с сортировкой', () => {
    const result = getGroups(
      items,
      getItemGroupKey,
      groups,
