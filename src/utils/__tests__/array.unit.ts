...
describe('sortBy', () => {
  ...
  test('сортирует функцией сортировки', () => {
    const arr = [
      {
        date: {
          day: 10,
  ...
  test('сортирует по числовому параметру в убывающем порядке', () => {
    const arr = [
      { a: 2 },
      { a: 200 },
      { a: 1 },
  ...
  test('сохраняет порядок элементов, если у них одинаковый параметр', () => {
    const arr = [
      { a: 1, b: 'b1' },
      { a: 1, b: 'b2' },
    ];
  ...
  test('сортирует по строковому параметру', () => {
    const arr = [
      { name: 'Андрей' },
      { name: 'Вадим' },
      { name: 'Никита' },
  ...
  test('сортирует по строковому параметру в убывающем порядке', () => {
    const arr = [
      { name: 'Андрей' },
      { name: 'Вадим' },
      { name: 'Никита' },
...
describe('updateAt', () => {
  ...
  test('ничего не делает, если индекс за пределами массива', () => {
