> Это инструкция по созданию и автоматической генерации иконок из SVG. Если вам нужно добавить иконку в Figma, загляните в [эту инструкцию](##LIBS.STAND.TAB/tab:design/stand:uikit-custom-addicons-stable)
