...
Тема — это основа. Без неё ничего не заработает. Чтобы подключить тему, добавьте в свой проект компонент [`Theme`](##LIBS.STAND/stand:uikit--components--theme--stable) и укажите пресет.
