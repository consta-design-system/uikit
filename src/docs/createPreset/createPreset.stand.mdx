...
[Подробнее про модификаторы](##LIBS.STAND.DEV/stand:uikit-components-theme-stable/hash:модификаторы)
...
Содержит сетку размеров шрифта и межстрочных интервалов. Значения используются в компоненте [`Text`](##LIBS.STAND.DEV/stand:uikit-components-text-stable) и всех текстовых
