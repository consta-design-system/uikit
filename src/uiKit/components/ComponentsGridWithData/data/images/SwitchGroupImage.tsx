...
function SwitchGroupImage(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 200 120" fill="none" {...props}>
      ...
      <rect
        ...
        strokeOpacity={0.28}
      />
      <circle cx={41.273} cy={24.273} r={7.727} fill="#004269" fillOpacity={0.28} />
      <rect
        x={32.5}
        y={87.5}
        width={33}
        ...
        strokeOpacity={0.28}
      />
      <circle cx={41.273} cy={96.273} r={7.727} fill="#004269" fillOpacity={0.28} />
