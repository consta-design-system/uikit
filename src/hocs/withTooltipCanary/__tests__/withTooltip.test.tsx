...
const testId = 'withTooltipCanary';
const tooltipRole = 'Tooltip';

const ButtonWithTooltip = withTooltip(Button);

const renderComponent = (props: WithTooltipProps) => {
  return render(
    <TooltipPropsProvider role={tooltipRole} {...props}>
      <ButtonWithTooltip data-testid={testId} label="Button" />
