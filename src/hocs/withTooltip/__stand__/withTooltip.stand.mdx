...
Остальные свойства тултипа — например, направление разворачивания, задаются так же, как у компонента [Popover](##LIBS.STAND/stand:uikit--components--popover--stable).
...
| `direction?`             | `Direction`               | `'upCenter'`      | см. [Popover](##LIBS.STAND/stand:uikit--components--popover--stable)                                                  |
| `possibleDirections?`    | `Direction[]`             | `Direction`       | см. [Popover](##LIBS.STAND/stand:uikit--components--popover--stable)                                                  |
| `spareDirection?`        | `Direction`               | `'downStartLeft'` | см. [Popover](##LIBS.STAND/stand:uikit--components--popover--stable)                                                  |
| `isInteractive?`         | `boolean`                 | `true`            | см. [Popover](##LIBS.STAND/stand:uikit--components--popover--stable)                                                  |
| `equalAnchorWidth?`      | `boolean`                 | `fasle`           | см. [Popover](##LIBS.STAND/stand:uikit--components--popover--stable)                                                  |
