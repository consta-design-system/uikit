...
1. Удалите из SVG атрибуты `fill`, `fillOpacity`, `width`, `height`.

> Если эти атрибуты останутся, иконки не будут меняться, когда поменяется размер компонента или тема

2. Добавьте `className="Icon-Svg"`.

```
<svg width="16" height="16" viewBox="0 0 16 16" className="Icon-Svg" xmlns="http://www.w3.org/2000/svg">
