...
- все иконки в библиотеке должны соответствовать типу `IconComponent` ([посмотреть тип `IconComponent`](https://github.com/gazprom-neft/consta-uikit/blob/master/src/icons/Icon/Icon.tsx#L36)).
